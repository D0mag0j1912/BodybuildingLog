...
/* harmony import */ var _haptic_9a9aa7ec_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./haptic-9a9aa7ec.js */ "BzyW");
...
let Toggle = class {
  ...
  onMove(detail) {
    if (shouldToggle(Object(_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_5__["i"])(this.el), this.checked, detail.deltaX, -10)) {
      this.checked = !this.checked;
      Object(_haptic_9a9aa7ec_js__WEBPACK_IMPORTED_MODULE_4__["c"])();
    }
  }
  ...
  render() {
    ...
    Object(_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__["e"])(true, el, name, checked ? value : '', disabled);
    return Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["H"], {
      ...
      role: "switch",
      class: Object(_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_6__["c"])(color, {
        [mode]: true,
        'in-item': Object(_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_6__["h"])('ion-item', el),
      ...
      htmlFor: inputId
    }, labelText), Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("input", {
      type: "checkbox",
      role: "switch",
      "aria-checked": `${checked}`,
      disabled: disabled,
...
//# sourceMappingURL=45.4ca3a0f0f166989d3ca8.js.map