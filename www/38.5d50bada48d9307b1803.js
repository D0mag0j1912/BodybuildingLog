...
/* harmony import */ var _spinner_configs_163ed7fb_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./spinner-configs-163ed7fb.js */ "URcI");
/*!
...
let Spinner = class {
  ...
  render() {
    const self = this;
    const mode = Object(_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_1__["b"])(self);
    ...
    return (Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: Object(_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_2__["c"])(self.color, {
        [mode]: true,
...
const buildCircle = (spinner, duration, index, total) => {
  ...
  return (Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("circle", { transform: data.transform || 'translate(32,32)', cx: data.cx, cy: data.cy, r: data.r, style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} })));
};
const buildLine = (spinner, duration, index, total) => {
  const data = spinner.fn(duration, index, total);
  data.style['animation-duration'] = duration + 'ms';
  return (Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("line", { transform: "translate(32,32)", y1: data.y1, y2: data.y2 })));
};
...
//# sourceMappingURL=38.5d50bada48d9307b1803.js.map