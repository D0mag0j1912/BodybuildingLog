...
/* harmony import */ var _hardware_back_button_ace6a71b_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./hardware-back-button-ace6a71b.js */ "jzet");
...
let Select = class {
  ...
  connectedCallback() {
    ...
    return Object(C_Development_trainingApk_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.mutationO = watchForOptions(_this.el, 'ion-select-option', /*#__PURE__*/Object(C_Development_trainingApk_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        _this.updateOverlayOptions();
      }));
    })();
  }
  ...
  open(event) {
    ...
    return Object(C_Development_trainingApk_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (_this2.interface === 'popover') {
        ...
        if (selectedEl) {
          Object(_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__["f"])(selectedEl);
        }
      }
  ...
  openPopover(ev) {
    ...
    return Object(C_Development_trainingApk_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mode = Object(_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__["b"])(_this3);
  ...
  openActionSheet() {
    ...
    return Object(C_Development_trainingApk_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const mode = Object(_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__["b"])(_this4);
  ...
  getLabel() {
    return Object(_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__["j"])(this.el);
  }
  ...
  render() {
    ...
    const {
      labelText,
      labelId
    } = Object(_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__["d"])(el, inputId);
    Object(_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__["e"])(true, el, name, parseValue(value), disabled);
    ...
    return Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["H"], {
      ...
      class: {
        [mode]: true,
        'in-item': Object(_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_5__["h"])('ion-item', el),
      ...
      part: textPart
    }, selectText), Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", {
      class: "select-icon",
      role: "presentation",
      part: "icon"
    }, Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", {
      class: "select-icon-inner"
    })), Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("label", {
      id: labelId
    }, displayLabel), Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", {
      type: "button",
      disabled: disabled,
      id: inputId,
...
let SelectOption = class {
  ...
  render() {
    return Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["H"], {
      role: "option",
      id: this.inputId,
      class: Object(_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__["b"])(this)
    });
  }
...
let SelectPopover = class {
  ...
  callOptionHandler(ev) {
    ...
    if (option && option.handler) {
      Object(_overlays_374d672e_js__WEBPACK_IMPORTED_MODULE_4__["s"])(option.handler, values);
    }
  }
  /**
  ...
  renderCheckboxOptions(options) {
    return options.map(option => Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-item", {
      class: Object(_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_5__["g"])(option.cssClass)
    }, Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-checkbox", {
      slot: "start",
      value: option.value,
      disabled: option.disabled,
      checked: option.checked
    }), Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-label", null, option.text)));
  }

  renderRadioOptions(options) {
    const checked = options.filter(o => o.checked).map(o => o.value)[0];
    return Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-radio-group", {
      value: checked
    }, options.map(option => Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-item", {
      class: Object(_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_5__["g"])(option.cssClass)
    }, Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-label", null, option.text), Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-radio", {
      value: option.value,
      disabled: option.disabled,
  ...
  render() {
    ...
    return Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["H"], {
      class: Object(_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__["b"])(this)
    }, Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-list", null, header !== undefined && Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-list-header", null, header), hasSubHeaderOrMessage && Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-item", null, Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-label", {
      class: "ion-text-wrap"
    }, subHeader !== undefined && Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("h3", null, subHeader), message !== undefined && Object(_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__["h"])("p", null, message))), this.renderOptions(options)));
  }
...
//# sourceMappingURL=36.86d3b34dd52e9cc5da55.js.map