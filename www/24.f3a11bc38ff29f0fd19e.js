...
/*!*******************************************************************************!*\
  ...
  \*******************************************************************************/
/*! exports provided: ion_picker_column_internal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ion_picker_column_internal", function() { return PickerColumnInternal; });
...
let PickerColumnInternal = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
      ...
      const scrollCallback = () => {
        Object(_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__["r"])(() => {
          if (timeout) {
          ...
          if (!this.hapticsStarted) {
            Object(_haptic_9a9aa7ec_js__WEBPACK_IMPORTED_MODULE_4__["a"])();
          ...
          if (activeElement !== activeEl) {
            Object(_haptic_9a9aa7ec_js__WEBPACK_IMPORTED_MODULE_4__["b"])();
          }
          ...
          timeout = setTimeout(() => {
            ...
            if (selectedItem.value !== this.value) {
              ...
              Object(_haptic_9a9aa7ec_js__WEBPACK_IMPORTED_MODULE_4__["h"])();
              this.hapticsStarted = false;
            }
          }, 250);
        });
  ...
  componentWillLoad() {
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = Object(_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__["g"])(this.el).querySelector(`.${PICKER_COL_ACTIVE}`);
  ...
  get activeItem() {
    return Object(_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_3__["g"])(this.el).querySelector(`.picker-item[data-value="${this.value}"]`);
  }
...
//# sourceMappingURL=24.f3a11bc38ff29f0fd19e.js.map